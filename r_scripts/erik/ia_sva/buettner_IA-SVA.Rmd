...
**Clarification statement**. In this markdown script the parts Erik has added/modified are stated with his name. The original information is stated as "we". 
...
Here cyclone is used to assign cell cycle phases. The correlation plots explain how correlated each cell cycle phase is for each SV. It is one plot for G1, one for S, and one for G2M. Vioplot visualizes how well the different SVs separate the cell cycle phases all together. 
