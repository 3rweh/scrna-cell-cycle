...
iasva.res_MGH31 <- iasva(summ_exp_MGH31, as.matrix(mod_MGH31[,-1]),verbose=FALSE, permute=FALSE, num.sv=15)
iasva.sv_MGH31 <- iasva.res_MGH31$sv

Cluster_MGH31 <- as.factor(iasva.sv_MGH31[,1] < 0.1) 
levels(Cluster_MGH31)=c("Cluster1","Cluster2")
table(Cluster_MGH31)

pairs(iasva.sv_MGH31[,1:15], main="IA-SVA", pch=21, col=color.vec[Cluster_MGH31],
...
cor(Num_Detected_Genes_MGH31, iasva.sv_MGH31[,1])
cor(Geo_Lib_MGH31, iasva.sv_MGH31[,1])
...
cc_fun <- function(g1,s,g2m) { 
  }

G1_MGH28 <- apply(iasva.sv_MGH28,2,[phase_MGH28=="G1"])
S_MGH28 <- iasva.sv_MGH28[,1][phase_MGH28=="S"]
G2M_MGH28 <- iasva.sv_MGH28[,1][phase_MGH28=="G2M"]
Unknown_MGH28 <- iasva.sv_MGH28[,1][phase_MGH28=="Unknown"]
vioplot(G1_MGH28, S_MGH28, G2M_MGH28, names=c("G1", "S", "G2M"), 
   col="gold", drawRect=TRUE)
title(xlab="Cell-cycle stage predictions", ylab="IA-SVA factor (SV1)")
```
...
G1_MGH29 <- iasva.sv_MGH29[,1][phase_MGH29=="G1"]
S_MGH29 <- iasva.sv_MGH29[,1][phase_MGH29=="S"]
G2M_MGH29 <- iasva.sv_MGH29[,1][phase_MGH29=="G2M"]
Unknown_MGH29 <- iasva.sv_MGH29[,1][phase_MGH29=="Unknown"]
vioplot(G1_MGH29, S_MGH29, G2M_MGH29, names=c("G1", "S", "G2M"), 
   col="gold", drawRect=TRUE)
title(xlab="Cell-cycle stage predictions", ylab="IA-SVA factor (SV1)")
```
