...
{	
	...
	get_g1 <- function(inp, v_2, v_3, reg, cycle_start)
	{
	...
	get_g2m <- function(inp, v_2, v_3, reg, cycle_start)
	{
		if (100 >= length(ordIndex))
		{
		  # Splits all vectors into n_1 regions
	...
	g1_b <- get_g1(g1_score, s_score, g2m_score, g1_r, cycle_start)
	g2m_b <- get_g2m(g2m_score, s_score, g1_score, g2m_r, cycle_start)
