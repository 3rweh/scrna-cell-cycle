...
source("reCAT_master/R/bayes_score_function.R")
source("reCAT_master/R/mean_score_function.R")
load("reCAT_master/data/tranning.RData")
load("reCAT_master/data/ccgene.RData")
