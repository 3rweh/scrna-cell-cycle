...
rdata_bu <- get_rdata(score_result_bu, ordIndex_bu, cycle_start_bu)
print(rdata_bu)
...
# find best region for assessing each phase
source("reCAT_master/R/get_rdata.R")
rdata_le <- get_rdata(score_result_le, ordIndex_le, cycle_start_le)
print(rdata_le)
...
# find best region for assessing each phase
source("reCAT_master/R/get_rdata.R")
rdata <- get_rdata(score_result, ordIndex, cycle_start)
print(rdata)
